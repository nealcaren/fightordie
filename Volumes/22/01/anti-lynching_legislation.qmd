...
description: "Defends the NAACP’s focused anti-lynching campaign, warning that splitting efforts harms race justice and freedom."
author:
  - name:
      given: W.E.B.
      family: Du Bois
...
subjects:
  ...
  - Lynching — statistics and investigation
  - Civil rights litigation and legal defense
  - Publicity campaigns and mass mobilization
people:
  - W. E. B. Du Bois
places:
  - Duluth, Minnesota
...
events:
  ...
  - National Conference on Lynching (New York, 1919)
citation: 
...
4. Sent 4,462,899 copies of the <span class="crisis-title">Crisis</span> to every state in the Union and to every country on the globe
