---
title: 'Education'
description: "Exposes systemic racial injustice in education, citing stark attendance, funding, and term-length disparities."
author:
  - name:
      given: W.E.B.
      family: Du Bois
...
subjects:
  ...
  - Segregated schooling (Southern United States)
  - School attendance rates
  - School term length disparities
  - School administration and supervision (rural South)
people:
  - W. E. B. Du Bois
  - V. P. Thomas
places:
...
organizations:
  ...
  - Lawrence American (Lawrence, Massachusetts)
citation: 
...
If once we go behind the official admissions the picture is even worse. As we pointed out in the January <span class="crisis-title">Crisis</span>, in one Alabama county out of 10,758 Negro children only 1,000 were in school. As to Louisiana, this is the way V. P. Thomas dissects the school report:
